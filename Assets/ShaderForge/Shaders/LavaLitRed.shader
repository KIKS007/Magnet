...
/////// Diffuse:
                ...
                float4 node_8084 = _Time + _TimeEditor;
                float2 node_3515 = (i.uv0+node_8084.g*float2(0,0.1));
                float4 _Layer1_var = tex2D(_Layer1,TRANSFORM_TEX(node_3515, _Layer1));
                float2 node_5482 = (i.uv0+node_8084.g*float2(0.5,0.3));
                ...
                float2 node_4922 = (i.uv0+node_8084.g*float2(0,0.2));
                ...
                float2 node_3039 = (i.uv0+node_8084.g*float2(1,0.5));
                ...
                float2 node_3076 = (i.uv0+node_8084.g*float2(0,0.4));
...
/////// Diffuse:
                float NdotL = max(0.0,dot( normalDirection, lightDirection ));
                float3 directDiffuse = max( 0.0, NdotL) * attenColor;
                float4 node_9446 = _Time + _TimeEditor;
                float2 node_3515 = (i.uv0+node_9446.g*float2(0,0.1));
                float4 _Layer1_var = tex2D(_Layer1,TRANSFORM_TEX(node_3515, _Layer1));
                float2 node_5482 = (i.uv0+node_9446.g*float2(0.5,0.3));
                float4 _Layer2_var = tex2D(_Layer2,TRANSFORM_TEX(node_5482, _Layer2));
                float4 _AlphaL2_var = tex2D(_AlphaL2,TRANSFORM_TEX(node_5482, _AlphaL2));
                float2 node_4922 = (i.uv0+node_9446.g*float2(0,0.2));
                float4 _Layer3_var = tex2D(_Layer3,TRANSFORM_TEX(node_4922, _Layer3));
                float4 _AlphaL3_var = tex2D(_AlphaL3,TRANSFORM_TEX(node_4922, _AlphaL3));
                float2 node_3039 = (i.uv0+node_9446.g*float2(1,0.5));
                float4 _Layer4_var = tex2D(_Layer4,TRANSFORM_TEX(node_3039, _Layer4));
                float4 _AlphaL4_var = tex2D(_AlphaL4,TRANSFORM_TEX(node_3039, _AlphaL4));
                float2 node_3076 = (i.uv0+node_9446.g*float2(0,0.4));
                float4 _Layer5_var = tex2D(_Layer5,TRANSFORM_TEX(node_3076, _Layer5));
                float4 _AlphaL5_var = tex2D(_AlphaL5,TRANSFORM_TEX(node_3076, _AlphaL5));
                float3 diffuseColor = lerp(lerp(lerp(lerp(_Layer1_var.rgb,_Layer2_var.rgb,_AlphaL2_var.rgb),_Layer3_var.rgb,_AlphaL3_var.rgb),_Layer4_var.rgb,_AlphaL4_var.rgb),_Layer5_var.rgb,_AlphaL5_var.rgb);
