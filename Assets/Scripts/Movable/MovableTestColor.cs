...
public class MovableTestColor : MonoBehaviour 
{
	...
	IEnumerator ColorTest ()
	{
		...
		cubeCorrectColor = GlobalVariables.Instance.playersColor[0];
		...
		DOTween.To(()=> cubeColorTemp, x=> cubeColorTemp =x, GlobalVariables.Instance.playersColor[4], tweenDuration).OnUpdate(()=> cubeMaterial.SetColor("_Color", cubeColorTemp));
		...
		cubeCorrectColor = GlobalVariables.Instance.playersColor[2];
		...
		cubeCorrectColor = GlobalVariables.Instance.playersColor[3];
		...
		cubeCorrectColor = GlobalVariables.Instance.playersColor[1];
